...
const PACKAGES_TO_AUTO_DETECT_EXPORTS = [path.join('node_modules', 'react', 'index.js'), path.join('node_modules', 'react-dom', 'index.js'), path.join('node_modules', 'react-is', 'index.js'), path.join('node_modules', 'prop-types', 'index.js'), // Note: rxjs/Rx.js depends on rxjs-compat as well.
...
async function install(arrayOfDeps, {
  ...
  const knownNamedExports = _objectSpread({}, namedExports);
